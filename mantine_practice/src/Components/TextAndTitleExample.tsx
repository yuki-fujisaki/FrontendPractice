...
function TitleAndTextExample() {
  return (
    <div>
      <Title order={2}>THIS IS A BIG 'OL TITLE</Title>
      <Text size="lg" weight={700} underline transform="capitalize">
        ...
        unde soluta laborum esse iure cupiditate error ipsum id, minima nesciunt
        dignissimos! Consequuntur, a? Odio nisi suscipit praesentium!
      </Text>
    </div>
  );
}
